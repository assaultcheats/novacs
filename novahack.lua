...
library:Init()
client:init()
if isfile("novahack/default.cr") then
    library:LoadConfig("default")
end 

client:console("novahack loaded in " .. tostring(tick() - start) .. "ms")
