...
CreditsSection:AddLabel("Made by: Duck.#1434")
...
if identifyexecutor then
	...
	if not supported then
		client:console("This executor is not supported. If you believe it will, contact Duck.#1434")
...
library:Init()
client:init()
if isfile("duoesense/default.duosense") then
